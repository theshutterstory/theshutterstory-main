      ...
      <div className="mx-auto max-w-screen-xl px-4 pb-6 sm:px-6 ">
        ...
        <div className="mt-16 border-t border-gray-100 pt-6 sm:flex sm:items-center sm:justify-between">
          ...
          <ul className="mt-4 flex justify-center gap-6 sm:mt-0 sm:justify-start">
            ...
            <li>
              <a
                href="https://www.instagram.com/wetheshutterstory/"
                rel="noreferrer"
                target="_blank"
                className="text-gradient-to-r from-cyan-500 to-blue-500 "
              >
            ...
            <li>
              <a
                href="https://twitter.com/theshutterstry"
                rel="noreferrer"
                target="_blank"
                className="text-blue-700 transition hover:text-blue-400/75"
              >
            ...
            <li>
              <a
                href="https://github.com/theshutterstory/theshutterstory-main"
                rel="noreferrer"
                target="_blank"
            ...
            <li>
              <a
                ...
                rel="noreferrer"
                target="_blank"
                className="text-pink-600 transition hover:text-pink-400/75"
              >
